...
export const updateThemeSchema = z.object({
  themeConfig: z.object({
    ...
    fontSize: z.union([z.enum(["small", "medium", "large", "custom"]), z.number()]).optional(),
    customFontSize: z.number().int().min(6).max(30).optional(),
    layout: z.enum(["SINGLE_COLUMN", "TWO_COLUMN_LEFT", "TWO_COLUMN_RIGHT", "THREE_PANEL"]).optional(),
