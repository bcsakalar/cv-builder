        ...
        {cv.projects.length > 0 && (
          <section className="mb-6">
            ...
            {projectsFooter.shouldRender && projectsFooter.url && projectsFooter.displayUrl && (
              <a href={projectsFooter.url} target="_blank" rel="noreferrer" className="inline-block text-xs font-medium underline-offset-2 hover:underline" style={{ color: theme.primaryColor }}>
